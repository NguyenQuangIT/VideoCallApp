package opensourceproject.videocallapp.firebase;
...
import opensourceproject.videocallapp.activities.IncomingInvitationActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage){
        ...
        if(type!=null){
            if(type.equals(Constants.REMOTE_MSG_INVITATION)){
                ...
                Intent intent = new Intent(Constants.REMOTE_MGS_INVITATION_RESPONSE);
                intent.putExtra(
                        Constants.REMOTE_MGS_INVITATION_RESPONSE,
                        remoteMessage.getData().get(Constants.REMOTE_MGS_INVITATION_RESPONSE)
                );
